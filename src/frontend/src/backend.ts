...
export class Backend implements backendInterface {
    ...
    async addWine(arg0: string, arg1: string, arg2: string | null, arg3: string, arg4: string, arg5: string | null, arg6: WineStyle, arg7: string, arg8: boolean, arg9: boolean, arg10: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addWine(arg0, arg1, to_candid_opt_n8(this._uploadFile, this._downloadFile, arg2), arg3, arg4, to_candid_opt_n8(this._uploadFile, this._downloadFile, arg5), to_candid_WineStyle_n9(this._uploadFile, this._downloadFile, arg6), arg7, arg8, arg9, to_candid_opt_n8(this._uploadFile, this._downloadFile, arg10));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteWine(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteWine(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getWines(): Promise<Array<Wine>> {
        if (this.processError) {
            try {
                const result = await this.actor.getWines();
    ...
    async updateWine(arg0: string, arg1: string, arg2: string | null, arg3: string, arg4: string, arg5: string | null, arg6: WineStyle, arg7: string, arg8: boolean, arg9: boolean, arg10: string | null): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_WineStyle_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _WineStyle): WineStyle {
    return from_candid_variant_n21(_uploadFile, _downloadFile, value);
}
function from_candid_Wine_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Wine): Wine {
...
function from_candid_record_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        region: record_opt_to_undefined(from_candid_opt_n19(_uploadFile, _downloadFile, value.region)),
...
function from_candid_variant_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "red" in value ? WineStyle.red : "sparkling" in value ? WineStyle.sparkling : "petNat" in value ? WineStyle.petNat : "orange" in value ? WineStyle.orange : "rose" in value ? WineStyle.rose : "white" in value ? WineStyle.white : value;
}
function from_candid_vec_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Wine>): Array<Wine> {
    return value.map((x)=>from_candid_Wine_n17(_uploadFile, _downloadFile, x));
}
...
function to_candid_WineStyle_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: WineStyle): _WineStyle {
...
function to_candid_variant_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: WineStyle): {
    red: null;
} | {
    sparkling: null;
} | {
    ...
    return value == WineStyle.red ? {
        red: null
    } : value == WineStyle.sparkling ? {
        sparkling: null
    } : value == WineStyle.petNat ? {
        petNat: null
    } : value == WineStyle.orange ? {
        orange: null
    } : value == WineStyle.rose ? {
        rose: null
    } : value == WineStyle.white ? {
        white: null
    } : value;
}
